...
PyType_Slot MGLTextureArray_slots[] = {
	{Py_tp_methods, MGLTextureArray_tp_methods},
	{Py_tp_getset, MGLTextureArray_tp_getseters},
	{0},
};

PyType_Spec MGLTextureArray_spec = {"MGLTextureArray", sizeof(MGLTextureArray), 0, Py_TPFLAGS_DEFAULT, MGLTextureArray_slots};
