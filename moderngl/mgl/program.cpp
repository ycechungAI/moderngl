...
PyObject * MGLContext_meth_program(MGLContext * self, PyObject * const * args, Py_ssize_t nargs) {
	...
	if (!linked) {
        ...
        printf("%p %p %p %p %p %p %p %p\n", moderngl_linker_error, args[0], args[1], args[2], args[3], args[4], args[5], (void *)0);
		...
		PyObject_CallFunctionObjArgs(moderngl_linker_error, args[0], args[1], args[2], args[3], args[4], args[5], (void *)0);
